...
5. **Классификация**:
    - Векторы признаков стандартизировались с помощью StandardScaler и классифицировались с использованием метода ближайших соседей. Данный классификатор показал на тестовой выборке лучшие результаты классификации. 
